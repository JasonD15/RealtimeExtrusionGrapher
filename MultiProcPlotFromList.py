...
#src_path = 'C:/Users/jason.dichoso/Dropbox/Python/DynamicGraphing/ExportedGraphs/folder1'
#dest_path = 'C:/Users/jason.dichoso/Dropbox/Python/DynamicGraphing/ExportedGraphs/folder2'
...
def loopProcess():
    ...
    proc.start()   
    while True:
        q = staticVariables.queue.get()  
        if q > 0:
            staticVariables.pid = q
        else:
            staticVariables.error = q                                                    
                ...
                while True:
                    try:
                        if self.count < 1:
                            ...
                            time.sleep(1)
                            #staticVariables.xyList = staticVariables.parent.recv()
                    ...
                    if staticVariables.OnGraphPage == False and staticVariables.pid != 0:
                        ...
                        break
                    staticVariables.xyList = staticVariables.parent.recv()    #check for connection errors first then grab csv data
